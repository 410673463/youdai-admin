package com.utour.youdai.admin.framework.web.controller;
...
import com.utour.youdai.admin.common.utils.sql.SqlUtil;
import com.utour.youdai.admin.framework.web.domain.AjaxResult;
import com.utour.youdai.admin.framework.web.page.PageDomain;
import com.utour.youdai.admin.framework.web.page.TableDataInfo;
import com.utour.youdai.admin.framework.web.page.TableSupport;
...
public class BaseController {
    ...
    protected  TableDataInfo returnList(List<?> list){
        TableDataInfo rspData = new TableDataInfo();
        rspData.setCode(HttpStatus.SUCCESS);
        rspData.setMsg("查询成功");
        rspData.setRows(list);
